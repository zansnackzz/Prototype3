...
class Holdd_noti_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_holdd_noti_)

        val getstatus = intent.getStringExtra(Detail_Show_For_New_Patient.Sstatuss) // Get From Firebase
        val getsymptom = intent.getStringExtra(Detail_Show_For_New_Patient.Ssymptommmm) // Get From Firebase
        ...
        if (getsymptom.equals(checksymptom)){
            ...
            if (getstatus.equals(getstatus1)){
                ...
                Handler().postDelayed({
                    val intent = Intent(this,NotificateActivity::class.java) //MainActivity NotificateActivity
                    ...
                    intent.putExtra(Ssymptommmm,getsymptom)
                    intent.putExtra(Sstatuss,getstatus)
