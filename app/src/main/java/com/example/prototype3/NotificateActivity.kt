...
class NotificateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val getstatus = intent.getStringExtra(Holdd_noti_Activity.Sstatuss) // Get From Firebase
        val getsymptom = intent.getStringExtra(Holdd_noti_Activity.Ssymptommmm) // Get From Firebase
                    ...
                    for (i in 1..12){
                        when (i){
                            ...
                            10->if (switch1_10.isChecked){
                                ParalysisS10NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11->if (switch1_11.isChecked){
                                ParalysisS11NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12->if (switch1_12.isChecked){
                                ParalysisS12NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
                ...
                btn_save_notiiddd.setOnClickListener{
                    for (i in 1..12){
                        when (i){
                            ...
                            10-> if (switch1_10.isChecked){
                                Paralysiss10S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11-> if (switch1_11.isChecked){
                                Paralysiss11S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12-> if (switch1_12.isChecked){
                                Paralysiss12S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
                ...
                btn_save_notiiddd.setOnClickListener{
                    for (i in 1..12){
                        when (i){
                            ...
                            10-> if (switch1_10.isChecked){
                                Paralysiss10S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11-> if (switch1_11.isChecked){
                                Paralysiss11S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12-> if (switch1_12.isChecked){
                                Paralysiss12S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
                ...
                btn_save_notiiddd.setOnClickListener{
                    for (i in 1..12){
                        when (i){
                            ...
                            10-> if (switch1_10.isChecked){
                                Parkinson10S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11-> if (switch1_11.isChecked){
                                Parkinson11S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12-> if (switch1_12.isChecked){
                                Parkinson12S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
                ...
                btn_save_notiiddd.setOnClickListener{
                    for (i in 1..12){
                        when (i){
                            ...
                            10-> if (switch1_10.isChecked){
                                Parkinson10S2NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11-> if (switch1_11.isChecked){
                                Parkinson11S2NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12-> if (switch1_12.isChecked){
                                Parkinson12S2NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
                ...
                btn_save_notiiddd.setOnClickListener{
                    for (i in 1..12){
                        when (i){
                            ...
                            10-> if (switch1_10.isChecked){
                                Parkinson10S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11-> if (switch1_11.isChecked){
                                Parkinson11S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12-> if (switch1_12.isChecked){
                                Parkinson12S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
                ...
                btn_save_notiiddd.setOnClickListener{
                    for (i in 1..12){
                        when (i){
                            ...
                            10-> if (switch1_10.isChecked){
                                Vascular10S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11-> if (switch1_11.isChecked){
                                Vascular11S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12-> if (switch1_12.isChecked){
                                Vascular12S1NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
                ...
                btn_save_notiiddd.setOnClickListener{
                    for (i in 1..12){
                        when (i){
                            ...
                            10-> if (switch1_10.isChecked){
                                Vascular10S2NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11-> if (switch1_11.isChecked){
                                Vascular11S2NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12-> if (switch1_12.isChecked){
                                Vascular12S2NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
                ...
                btn_save_notiiddd.setOnClickListener{
                    for (i in 1..12){
                        when (i){
                            ...
                            10-> if (switch1_10.isChecked){
                                Vascular10S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            11-> if (switch1_11.isChecked){
                                Vascular11S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }

                            12-> if (switch1_12.isChecked){
                                Vascular12S3NU().setNotification(mNotificationTime, this@NotificateActivity)
                            }
