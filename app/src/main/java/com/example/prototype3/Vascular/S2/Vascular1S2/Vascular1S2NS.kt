...
class Vascular1S2NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Vascular1S2RA::class.java)

            val title = "โรคหลอดเลือด"
            val message = "07.00-08.00 น.  ออกกำลังกาย เช่น เดินเร็ว ขยับแขนขา"
