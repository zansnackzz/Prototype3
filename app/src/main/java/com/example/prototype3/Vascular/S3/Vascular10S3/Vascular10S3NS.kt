...
class Vascular10S3NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Vascular10S3RA::class.java)

            val title = "โรคหลอดเลือด"
            val message = "18.00-19.00 น.  ให้ผู้ป่วยได้พักผ่อน "
