...
class Vascular12S3NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Vascular12S3RA::class.java)

            val title = "โรคหลอดเลือด"
            val message = "22.00 น.  รับประทานยาตามที่แพทย์สั่งและให้ผู้ป่วยพักผ่อนให้เพียงพอ"
