...
class Paralysiss12S3NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Paralysiss12S3RA::class.java)

            val title = "โรคอัมพฤกษ์-อัมพาต"
            val message = "22.00 น.  รับประทานยาที่แพทย์สั่งแลให้ผู้ป่วยะพักผ่อนให้เพียงพอ"
