...
class ParalysisS11NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, ParalysisS11RA::class.java)

            val title = "โรคอัมพฤกษ์-อัมพาต"
            val message = "20.00-21.00 น. หากิจกรรมทำเพื่อให้รู้สึกผ่อนคลาย "
