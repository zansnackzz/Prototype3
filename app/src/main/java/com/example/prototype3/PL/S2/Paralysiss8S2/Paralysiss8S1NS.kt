package com.example.prototype3.PL.S2.Paralysiss8S2
...
class Paralysiss8S1NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Paralysiss8S1AR::class.java)
