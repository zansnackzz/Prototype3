...
class Paralysiss5S3NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Paralysiss5S3RA::class.java)

            val title = "โรคอัมพฤกษ์-อัมพาต"
            val message = "12.00-15.00 น.  ให้ผู้ป่วยได้พักผ่อน"
