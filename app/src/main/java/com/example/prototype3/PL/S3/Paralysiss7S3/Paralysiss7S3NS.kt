package com.example.prototype3.PL.S3.Paralysiss7S3
...
class Paralysiss7S3NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Paralysiss7S3RA::class.java)
