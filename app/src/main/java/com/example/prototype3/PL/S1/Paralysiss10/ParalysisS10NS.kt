...
class ParalysisS10NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, ParalysisS10RA::class.java)

            val title = "โรคอัมพฤกษ์-อัมพาต"
            val message = "19.00-20.00 น.  ทำกิจวัตรประจำวัน"
