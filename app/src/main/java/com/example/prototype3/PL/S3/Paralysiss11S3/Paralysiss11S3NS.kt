...
class Paralysiss11S3NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Paralysiss11S3RA::class.java)

            val title = "โรคอัมพฤกษ์-อัมพาต"
            val message = "20.00-21.00 น.  ทำกายภาพบำบัดตามที่แพทย์สั่ง"
