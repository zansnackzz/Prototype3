...
class Paralysiss5S1NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Paralysiss5S1RA::class.java)

            val title = "โรคอัมพฤกษ์-อัมพาต"
            val message = "12.00-13.00 น.  ทำกายภาพบำบัดตามที่แพทย์สั่ง"
