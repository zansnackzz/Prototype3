...
class Paralysiss3S1NS : IntentService("NotificationService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, Paralysiss3S1RA::class.java)

            val title = "โรคอัมพฤกษ์-อัมพาต"
            val message = "10.00-11.00 น. ให้ผู้ป่วยฝึกใช้กล้ามเนื้อมือ เช่น เขียนหนังสือ"
